...
function showSettingsPopout() {
    document.getElementById('settings-popout').style.display = 'flex';
}

function hideSettingsPopout() {
...
function setItemsPerPage(items) {
    const itemsBtn = document.getElementById('itemsPerPagePopup');
    itemsBtn.textContent = items === 'all' ? 'All' : items || 'Page'; // Tampilkan jumlah tabel atau default "Page"
    const params = new URLSearchParams(window.location.search);
    if (items) {
        params.set('itemsPerPage', items);
    } else {
...
function openItemsPerPagePopup() {
    document.getElementById('itemsPerPagePopup').style.display = 'flex';
}

function closeItemsPerPagePopup() {
    document.getElementById('itemsPerPagePopup').style.display = 'none';
}
