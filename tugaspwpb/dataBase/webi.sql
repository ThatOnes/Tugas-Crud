...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Bulan Mei 2025 pada 22.15
...
(100, 'Zankyou no Terror', 'Misteri', 11, '100.png');
...
INSERT INTO `episode` (`ID`, `episode`, `subs`) VALUES
(1, '1', 0),
(2, '2', 0),
(3, '3', 0),
(4, '4', 0),
...
--
-- Struktur dari tabel `requestav`
--

CREATE TABLE `requestav` (
  `ID` int(255) NOT NULL,
...
--
-- Dumping data untuk tabel `requestav`
--

INSERT INTO `requestav` (`ID`, `request`, `email`) VALUES
(1, 'maomao', ''),
(2, '12321', ''),
(3, '12321', '');
...
--
-- Dumping data untuk tabel `userav`
--

INSERT INTO `userav` (`ID`, `username`, `password`, `subs`, `picture`) VALUES
(0, 'Kevin', '123', 1, 'kev.gif'),
(1, 'test', '123', 0, 'default.png'),
(2, 'rill', '123', 1, 'rillYapping.gif');
...
--
-- Indeks untuk tabel `requestav`
--
ALTER TABLE `requestav`
  ADD PRIMARY KEY (`ID`);

--
-- Indeks untuk tabel `userav`
--
ALTER TABLE `userav`
  ADD PRIMARY KEY (`ID`);
COMMIT;
