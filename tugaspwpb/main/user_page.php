...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const restrictPages = ['delete_account.php', 'change_username.php', 'change_password.php'];

        if(document.referrer){
            const referrerPage = document.referrer.split('/').pop();
            if(restrictPages.includes(referrerPage)){
...
<div class="settings-popout" id="settings-popout">
    <div class="settings-box">
        ...
        <button class="settings-button" onclick="window.location.href='/tugaspwpb/main/delete_account.php'"
        <?php if ($user_id == 0) echo 'style="display: none;"'; ?>>Hapus Akun</button>
