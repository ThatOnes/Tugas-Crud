...
$totalItemsQuery = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM buku");
...
$data = mysqli_query($koneksi, "SELECT * FROM buku LIMIT $offset, $itemsPerPage");
